...
export default function ClientInfo({ clientData, branch, trader }: ClientInfoProps) {
  ...
  const total = sumField(filteredList, 'totalInvestor');
  const active = sumField(filteredList, 'performer');
  const inactive = sumField(filteredList, 'nonePerformer');
  const ibrokerInvestor = sumField(filteredList, 'ibrokerInvestor');
  const tExpressInvestor = sumField(filteredList, 'texpressInvestor');
