...
import { DataTablePagination } from "./_investorLiveBuySaleTablePagination";
import { DataTableToolbar } from "./_investorLiveBuySaleTableToolbar";
                ...
                {headerGroup.headers.map((header) => {
                  return (
                    <TableHead
                      ...
                      className="border text-black font-bold"
                    >
