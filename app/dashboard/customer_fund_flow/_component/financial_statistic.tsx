  ...
  return (
    ...
    >
      ...
      <CardHeader className="relative z-10 bg-gradient-to-r from-teal-700 via-cyan-600 to-sky-700 p-2 ">
        <CardTitle className="text-sm sm:text-lg font-semibold text-white tracking-wide drop-shadow-md">
          {title}
        </CardTitle>
      </CardHeader>

      <CardContent className="relative z-10 p-5">
        <p className="text-2xl sm:text-3xl font-bold text-white drop-shadow-sm tracking-wide">
          {numberToMillionsString(amount)}
        </p>
        <div className="mt-3 w-12 sm:w-16 h-[3px] bg-gradient-to-r from-teal-400 to-sky-400 rounded-full"></div>
      </CardContent>
    </Card>
