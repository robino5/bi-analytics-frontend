...
const BarChart: FC<BarChartProps> = ({ data, option,setSelectedBar }) => {
...
const BarChartHorizontalComparison: FC<BarChartHorizontalComparisonProps> = ({ data, options }) => {
  const [selectedBar, setSelectedBar] = useState<BarData | null>(null); 
  return data.length ? (
    <>
    <BarChart data={data} option={options} setSelectedBar={setSelectedBar}/>
